...
ASSISTANT_COUNT=0
for VAR_NAME in EUROPEAN_ASTROLOGY_ASSISTANT_ID WESTERN_ASTROLOGY_ASSISTANT_ID CHINESE_ASTROLOGY_ASSISTANT_ID INDIAN_ASTROLOGY_ASSISTANT_ID LAL_KITAB_ASSISTANT_ID KARMIC_ASTROLOGY_ASSISTANT_ID JYOTISH_ASSISTANT_ID ESOTERIC_ASTROLOGY_ASSISTANT_ID NUMEROLOGY_ASSISTANT_ID TAROT_ASSISTANT_ID PLANETARY_ASTROLOGY_ASSISTANT_ID PREDICTIVE_ASTROLOGY_ASSISTANT_ID LIGHT_ASTROLOGY_ASSISTANT_ID FORECASTING_ASSISTANT_ID ASTROLOGY_FORECASTING_ASSISTANT_ID; do
  if [ -n "${!VAR_NAME}" ]; then
