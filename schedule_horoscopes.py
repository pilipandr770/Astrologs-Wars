...
# Запускаем при первом запуске (если необходимо, раскомментируйте строку ниже)
# run_horoscope_generation()

logger.info("Планировщик гороскопов запущен")
print("Планировщик гороскопов запущен. Генерация будет выполняться ежедневно в 3:00.")
