...
# Copy functions and main execution logic from the original script here
...
def create_horoscope_block(system_key, content):
    """
    Create a blog block for the horoscope content.
    """
    if not content:
...
def log_generation_activity(system, success, message=""):
    """
    Log generation activity to the database
    """
    try:
